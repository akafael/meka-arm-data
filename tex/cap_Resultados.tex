...
% Resposta do Sensor
Como mostrado na tabela \ref{tab:a2armSensorDoc} não existe um sensor de velocidade embarcado em cada uma das juntas. A medida fornecida de velocidade é uma estimativa com base no valor da posição. Assim para estudar em mais detalhes a resposta do atuador foi feito uma análise da resposta do tópico em comparação com a estimativa da velocidade calculada diretamente.
...
Dado que a velocidade máxima da junta mais rápida é de $4.6 rad/s$ a variação máxima esperada é de $f_0 = 1/(2pi/4.6 rad/s) = 0.732 Hz$. De modo pode ser utilizado um filtro passa baixa com a frequência de corte mais baixa para avaliar o comportamento da velocidade em conjunto com a estimativa obtida diretamente pela posição.

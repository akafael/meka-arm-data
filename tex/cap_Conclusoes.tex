...
Neste trabalho foi apresentado um detalhamento maior da arquitetura de controle implementada no Meka permitindo conhecer os fundamentos das tecnologias envolvidas no desenvolvimento de manipuladores robóticos cooperativos. Foi percebido que nos trabalhos anteriores foi alcançado o limite de desempenho dos controladores implementados para o controle de juntas do robô. No entanto dado as características do sistema embarcado e do atuadores ainda existe um enorme potencial que pode ser explorado para permitir um maior desempenho.

\subsection{Trabalhos Futuros}

Para trabalhos futuros é sugerido a identificação do modelo dos atuadores série elástico disponíveis na plataforma visando a implementação de um controle de juntas mais preciso. 

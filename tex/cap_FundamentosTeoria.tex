...
% Autodiferenciação
Em razão de suas propriedades, a representação a partir de números duais que vêm ganhando espaço em várias áreas como a robótica \cite{Adorno2011} e a computação gráfica para renderização \cite{kavan2006dual} por permitirem o cálculo de forma mais eficiente com menos distorções. % cite?

...
A compensação da gravidade é feita a partir do calculo do modelo dinâmico pela $M3Dynamatics$ e em seguida passada como uma ação de controle em $feedforwad$ para o torque das juntas em $M3Joint$ para ser por fim executado em $M3ActuatorEc$.
